...
// Check if the category parameter is set in the URL and matches the "Welfare Director" category
if (isset($_GET['category']) && $_GET['category'] === 'Welfare Director') {
    // Retrieve the list of candidates who applied for Welfare Director from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Welfare Director'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='9'>"; // Assuming category_id 9 corresponds to 'Welfare Director'
...
<script>
    ...
    if ('speechSynthesis' in window) {
        ...
        var speechPhrase = new SpeechSynthesisUtterance('This is the welfare director dashboard page, please select your candidate');
