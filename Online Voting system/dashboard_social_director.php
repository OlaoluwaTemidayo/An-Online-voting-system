...
// Check if the category parameter is set in the URL and matches the "Social Director" category
if (isset($_GET['category']) && $_GET['category'] === 'Social Director') {
    // Retrieve the list of candidates who applied for Social Director from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Social Director'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='11'>"; // Assuming category_id 11 corresponds to 'Social Director'
...
<script>
    ...
    if ('speechSynthesis' in window) {
        ...
        var speechPhrase = new SpeechSynthesisUtterance('This is the social director  dashboard page, please select your candidate');
