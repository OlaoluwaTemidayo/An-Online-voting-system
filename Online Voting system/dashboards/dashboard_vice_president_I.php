...
if (isset($_GET['category']) && $_GET['category'] === 'Vice President I') {
    // Retrieve the list of candidates who applied for Vice President I from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Vice President I'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='2'>"; // Assuming category_id 2 corresponds to 'Vice President'
