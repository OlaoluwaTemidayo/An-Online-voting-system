...
// Check if the category parameter is set in the URL and matches the "Auditor General" category
if (isset($_GET['category']) && $_GET['category'] === 'Auditor General') {
    // Retrieve the list of candidates who applied for Auditor General from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Auditor General'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='8'>"; // Assuming category_id 8 corresponds to 'Auditor General'
