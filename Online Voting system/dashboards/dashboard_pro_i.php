...
// Check if the category parameter is set in the URL and matches the "Pro I" category
if (isset($_GET['category']) && $_GET['category'] === 'Pro I') {
    // Retrieve the list of candidates who applied for Pro I from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Pro I'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='12'>"; // Assuming category_id 12 corresponds to 'Pro I'
