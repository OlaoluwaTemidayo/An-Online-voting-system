...
// Check if the category parameter is set in the URL and matches the "Vice President I" category
if (isset($_GET['category']) && $_GET['category'] === 'Secretary General') {
    // Retrieve the list of candidates who applied for Secretary General from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Secretary General'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='4'>"; // Assuming category_id 2 corresponds to 'Secretary General'
