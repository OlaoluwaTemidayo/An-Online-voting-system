...
// Check if the category parameter is set in the URL and matches the "DPRS" category
if (isset($_GET['category']) && $_GET['category'] === 'DPRS') {
    // Retrieve the list of candidates who applied for DPRS from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'DPRS'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='14'>"; // Assuming category_id 14 corresponds to 'DPRS'
