...
// Check if the category parameter is set in the URL and matches the "Sales Director" category
if (isset($_GET['category']) && $_GET['category'] === 'Sales Director') {
    // Retrieve the list of candidates who applied for Sales Director from the candidates table
    $sql = "SELECT * FROM candidates WHERE category = 'Sales Director'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='15'>"; // Assuming category_id 15 corresponds to 'Sales Director'
...
<script>
    ...
    if ('speechSynthesis' in window) {
        ...
        var speechPhrase = new SpeechSynthesisUtterance('This is the sales director dashboard page, please select your candidate');
