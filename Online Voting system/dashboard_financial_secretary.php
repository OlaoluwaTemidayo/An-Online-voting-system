...
// Check if the category parameter is set in the URL and matches the "Financial Secretary" category
if (isset($_GET['category']) && $_GET['category'] === 'Financial Secretary') {
    // Retrieve the list of candidates who applied for Financial Secretaryv from the candidates table
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<input type='hidden' name='category_id' value='6'>"; // Assuming category_id 2 corresponds to 'Financial Secretary'
...
<script>
    ...
    if ('speechSynthesis' in window) {
        ...
        var speechPhrase = new SpeechSynthesisUtterance('This is the financial secretary dashboard page, please select your candidate');
